  ...
  return (
    <main className="relative flex min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute left-[-120px] top-[-120px] h-[320px] w-[320px] rounded-full bg-emerald-500/20 blur-3xl animate-pulse" />

        <div className="absolute bottom-[-150px] right-[-100px] h-[350px] w-[350px] rounded-full bg-cyan-500/20 blur-3xl animate-pulse" />
      </div>
        ...
        <div>
          ...
          <div className="mt-20 animate-[fadeInUp_1s_ease]">
            ...
            <h2 className="max-w-lg text-5xl font-black leading-tight">
              Secure investments with powerful returns.
            </h2>

            <p className="mt-6 max-w-md text-lg leading-8 text-slate-300">
              Manage your investment cycles, monitor wallet growth,
              earn referral rewards, and build long-term wealth with confidence.
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-4">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-5 backdrop-blur">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold">Protected Transactions</h3>
          ...
          <div className="rounded-[32px] border border-slate-200 bg-white/70 p-8 shadow-2xl backdrop-blur-xl dark:border-slate-800 dark:bg-slate-900/70">
            ...
            <form className="mt-8 space-y-5" onSubmit={onSubmit}>
              <div>
                ...
                <input
                  className="auth-input w-full rounded-2xl border border-slate-200 bg-white px-4 py-4 text-slate-900 outline-none transition focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-100"
